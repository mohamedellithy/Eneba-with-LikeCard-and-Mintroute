...
Route::group(['prefix' => 'applications','as' => 'application.'],function(){
    ...
    Route::controller(EnebaApplication::class)->group(function(){
        ...
        Route::get('eneba/callback-stock-provision','eneba_callback')->name('eneba.callback_stock_provision');
        Route::get('eneba/callback-stock-reservation','eneba_callback')->name('eneba.callback_stock_reservation');
